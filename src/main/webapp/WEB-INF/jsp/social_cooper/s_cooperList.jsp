    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $("#search").on("click", function(e){ //검색하기 버튼
                e.preventDefault();
                fn_openS_CooperSearch();
            });
             
            $("a[name='title']").on("click", function(e){ //제목
                e.preventDefault();
                fn_openS_CooperDetail($(this));
            });
        });
         
         
        function fn_openS_CooperWrite(){
            var comSubmit = new ComSubmit();
            comSubmit.setUrl("<c:url value='/s_cooper/openS_CooperWrite.do' />");
            comSubmit.submit();
        }
        
        function fn_ExcelDown(){
            var comSubmit = new ComSubmit();
            comSubmit.setUrl("<c:url value='/s_cooper/ExcelDown.do' />");
            comSubmit.submit();
        }
        
        function fn_openS_CooperSearch(){
            var comSubmit = new ComSubmit();
            comSubmit.setUrl("<c:url value='/s_cooper/openS_CooperSearch.do' />");
            comSubmit.addParam("cooperative_name", $('#cooperative_name').val());
            comSubmit.submit();
        }
         
        function fn_openS_CooperDetail(obj){
            var comSubmit = new ComSubmit();
            comSubmit.setUrl("<c:url value='/s_cooper/openS_CooperDetail.do' />");
