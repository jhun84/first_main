...
<br/>
    ...
    <script type="text/javascript">
        ...
        function fn_openS_CooperWrite(){
            ...
            comSubmit.setUrl("<c:url value='/sample/openS_CooperWrite.do' />");
            comSubmit.submit();
        }
        
        function fn_openS_CooperSearch(){
            var comSubmit = new ComSubmit();
            comSubmit.setUrl("<c:url value='/sample/openS_CooperSearch.do' />");
            comSubmit.submit();
        }
         
        function fn_openS_CooperDetail(obj){
            var comSubmit = new ComSubmit();
            comSubmit.setUrl("<c:url value='/sample/openS_CooperDetail.do' />");
