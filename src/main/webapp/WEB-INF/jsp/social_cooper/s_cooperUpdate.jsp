...
<body>
	...
	var gfv_count = 1;
		...
		function fn_updateS_Cooper(){
			var comSubmit = new ComSubmit("frm");
			comSubmit.setUrl("<c:url value='/s_cooper/updateS_Cooper.do' />");
			comSubmit.submit();
		}
		
		function fn_deleteS_Cooper(){
			var comSubmit = new ComSubmit();
			comSubmit.setUrl("<c:url value='/s_cooper/deleteS_Cooper.do' />");
