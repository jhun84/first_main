 ...
 <div id="people_info">
  ...
  <c:choose>
            ...
            <tr>
              ...
              <th>사회적일자리배정인원</th>
              <td><input type="text" name="social_people_0" value="${row.social_people}"></td>
              <th>전문인력배정인원</th>
              <td><input type="text" name="prof_people_0" value="${row.prof_people}"></td>
             </tr>
             <tr>
              <th>유급근로자수</th>
              <td><input type="text" name="salary_people_0" value="${row.salary_people}"></td>
              <th>취약계층근로자수</th>
              <td><input type="text" name="vul_people_0" value="${row.vul_people}"></td>
              <th></th>
              <td></td>
             </tr>
            </c:forEach>
