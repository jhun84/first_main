    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $("#search").on("click", function(e){ //검색하기 버튼
                e.preventDefault();
                fn_openSenterpriseSearch();
            });
             
            $("a[name='title']").on("click", function(e){ //제목
                e.preventDefault();
                fn_openSenterpriseDetail($(this));
            });
        });
         
         
        function fn_openSenterpriseWrite(){
            var comSubmit = new ComSubmit();
            comSubmit.setUrl("<c:url value='/s_enterprise/openSenterpriseWrite.do' />");
            comSubmit.submit();
        }
        
        function fn_ExcelDown(){
            var comSubmit = new ComSubmit();
            comSubmit.setUrl("<c:url value='/s_enterprise/ExcelDown.do' />");
            comSubmit.submit();
        }
        
        function fn_openSenterpriseSearch(){
            var comSubmit = new ComSubmit();
            comSubmit.setUrl("<c:url value='/s_enterprise/openSenterpriseSearch.do' />");
            comSubmit.addParam("company_name", $('#company_name').val());
            comSubmit.submit();
        }
         
        function fn_openSenterpriseDetail(obj){
            var comSubmit = new ComSubmit();
            comSubmit.setUrl("<c:url value='/s_enterprise/openSenterpriseDetail.do' />");
