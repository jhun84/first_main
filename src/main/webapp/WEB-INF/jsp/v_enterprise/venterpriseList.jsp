    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $("#search").on("click", function(e){ //검색하기 버튼
                e.preventDefault();
                fn_openVenterpriseSearch();
            });
             
            $("a[name='title']").on("click", function(e){ //제목
                e.preventDefault();
                fn_openVenterpriseDetail($(this));
            });
        });
         
         
        function fn_openVenterpriseWrite(){
            var comSubmit = new ComSubmit();
            comSubmit.setUrl("<c:url value='/v_enterprise/openVenterpriseWrite.do' />");
            comSubmit.submit();
        }
        
        function fn_ExcelDown(){
            var comSubmit = new ComSubmit();
            comSubmit.setUrl("<c:url value='/v_enterprise/ExcelDown.do' />");
            comSubmit.submit();
        }
        
        function fn_openVenterpriseSearch(){
            var comSubmit = new ComSubmit();
            comSubmit.setUrl("<c:url value='/v_enterprise/openVenterpriseSearch.do' />");
            comSubmit.addParam("company_name", $('#company_name').val());
            comSubmit.submit();
        }
         
        function fn_openVenterpriseDetail(obj){
            var comSubmit = new ComSubmit();
            comSubmit.setUrl("<c:url value='/v_enterprise/openVenterpriseDetail.do' />");
